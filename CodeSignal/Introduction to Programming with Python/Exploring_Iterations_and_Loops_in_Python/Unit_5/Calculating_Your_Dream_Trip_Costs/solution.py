...
chosen_countries = [
    ...
    "Italy",
    "Spain",
]  # This list may be a result of former selection logic
...
for country in chosen_countries:
    total_trip_cost += country_costs[
        country
    ]  # Summing up the cost for each chosen country

average_cost_per_country = total_trip_cost / len(
    chosen_countries

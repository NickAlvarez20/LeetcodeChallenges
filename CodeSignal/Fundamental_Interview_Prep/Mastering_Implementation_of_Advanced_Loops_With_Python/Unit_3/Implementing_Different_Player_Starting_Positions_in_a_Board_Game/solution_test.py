...
class SolutionTests(unittest.TestCase):
    ...
    def test02(self):
        self.assertEqual(
            solution([2, 4, 2, 1, 3, 2, 8, 4, 7], 4), [-1, -1, -1, -1, -1, -1, 1, -1, 1]
        )
    ...
    def test08(self):
        self.assertEqual(
            solution([i for i in range(1, 11)] * 2, 10),
            [5, 4, 5, 3, -1, 4, 3, 2, 2, -1, 4, 3, 2, 2, -1, 1, 1, 1, 1, -1],
        )

    def test09(self):
        self.assertEqual(
            solution([i for i in range(1, 11)] * 2, 1),
            [-1, 4, 5, 3, 3, 4, 3, 2, 2, 2, -1, 3, 2, 2, 2, 1, 1, 1, 1, 1],
        )

    def test10(self):
        self.assertEqual(
            solution([10 - i for i in range(10)] * 50, 5),
            [50 - i // 10 if i % 10 != 5 else -1 for i in range(500)],
        )
